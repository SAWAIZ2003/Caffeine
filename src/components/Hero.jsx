export default function Hero(){
     return (
        <>
            <h1>Coffee Tracking for Coffee<abbr title="An enthusiat or devotee">Fiends</abbr>!</h1>
            <div className="benefist-list">
            ...
            <div className="card info-card">
                ...
                drink a cup of coffee with 200 mg of caffeine, 5 hours, later, 
