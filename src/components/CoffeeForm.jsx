...
export default function CoffeeForm(props){
  ...
  async  function handleSubmitForm() {
        ...
        //define a guard clause that only submits the from if it is completed
        ...
        try {
           ...
           const timeToSubtract = (hour*60*60*100) + (min*60*100)
       ...
       // persist the data in the firebase firestore
             const userRef = doc(db,'usera' , globalUser.uid)
